...
- [Angular Steps Component](https://primeng.org/steps): Steps also known as Stepper, is an indicator for the steps in a workflow. Layout of steps component is optimized for responsive design.
